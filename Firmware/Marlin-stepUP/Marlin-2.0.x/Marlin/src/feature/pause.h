...
enum PauseMessage : char {
  ...
  PAUSE_MESSAGE_COLDPULL,
  PAUSE_MESSAGE_CONT_PULL,
...
bool cold_pull_filament(const bool show_lcd=false, const PauseMode mode=PAUSE_MODE_PAUSE_PRINT
  #if BOTH(FILAMENT_UNLOAD_ALL_EXTRUDERS, MIXING_EXTRUDER)
    , const float &mix_multiplier=1.0
  #endif
);
