...
#if ENABLED(AUTO_POWER_CONTROL)
  #define  ENABLE_AXIS_X() do{ powerManager.power_on(); ENABLE_STEPPER_X(); ENABLE_STEPPER_X2(); }while(0)
  #define  ENABLE_AXIS_Y() do{ powerManager.power_on(); ENABLE_STEPPER_Y(); ENABLE_STEPPER_Y2(); }while(0)
  #define  ENABLE_AXIS_Z() do{ powerManager.power_on(); ENABLE_STEPPER_Z();  ENABLE_STEPPER_Z2();  ENABLE_STEPPER_Z3();  ENABLE_STEPPER_Z4(); }while(0)
#else 
...
//
  ...
  #if ENABLED(AUTO_POWER_CONTROL)
    #define  ENABLE_AXIS_E0() do{ powerManager.power_on(); RREPEAT(MIXING_STEPPERS, _CALL_ENA_E); }while(0)
  #else
  ...
  #define DISABLE_AXIS_E0() { RREPEAT(MIXING_STEPPERS, _CALL_DIS_E) }
    ...
    #if ENABLED(AUTO_POWER_CONTROL)
      #define  ENABLE_AXIS_E0() do{ powerManager.power_on(); ENABLE_STEPPER_E0(); }while(0);
    #else
  ...
  #if E_STEPPERS > 1 && HAS_E1_ENABLE
    #if ENABLED(AUTO_POWER_CONTROL)
      #define  ENABLE_AXIS_E1() do{ powerManager.power_on(); ENABLE_STEPPER_E1(); }while(0);
    #else
  ...
  #if E_STEPPERS > 2 && HAS_E2_ENABLE
    #if ENABLED(AUTO_POWER_CONTROL)
      #define  ENABLE_AXIS_E2() do{ powerManager.power_on(); ENABLE_STEPPER_E2(); }while(0);
    #else
  ...
  #if E_STEPPERS > 3 && HAS_E3_ENABLE
    #if ENABLED(AUTO_POWER_CONTROL)
      #define  ENABLE_AXIS_E3() do{ powerManager.power_on(); ENABLE_STEPPER_E3(); }while(0);
    #else
  ...
  #if E_STEPPERS > 4 && HAS_E4_ENABLE
    #if ENABLED(AUTO_POWER_CONTROL)
      #define  ENABLE_AXIS_E4() do{ powerManager.power_on(); ENABLE_STEPPER_E4(); }while(0);
    #else
  ...
  #if E_STEPPERS > 5 && HAS_E5_ENABLE
    #if ENABLED(AUTO_POWER_CONTROL)
      #define  ENABLE_AXIS_E5() do{ powerManager.power_on(); ENABLE_STEPPER_E5(); }while(0);
    #else
  ...
  #if E_STEPPERS > 6 && HAS_E6_ENABLE
    #if ENABLED(AUTO_POWER_CONTROL)
      #define  ENABLE_AXIS_E6() do{ powerManager.power_on(); ENABLE_STEPPER_E6(); }while(0);
    #else
  ...
  #if E_STEPPERS > 7 && HAS_E7_ENABLE
    #if ENABLED(AUTO_POWER_CONTROL)
      #define  ENABLE_AXIS_E7() do{ powerManager.power_on(); ENABLE_STEPPER_E7(); }while(0);
    #else
