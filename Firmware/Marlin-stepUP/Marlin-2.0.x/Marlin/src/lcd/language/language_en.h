...
namespace Language_en {
  ...
  PROGMEM Language_Str MSG_SHUTDOWN_PS                     = _UxGT("Shutdown PSU");
  PROGMEM Language_Str MSG_CANCEL_SHUTDOWN_PS              = _UxGT("Cancel Shutdown");
  ...
  PROGMEM Language_Str MSG_ENABLE_AUTO_LEDS                = _UxGT("Enable Auto LEDs");
  PROGMEM Language_Str MSG_DISABLE_AUTO_LEDS               = _UxGT("Disable Auto LEDs");
  ...
  PROGMEM Language_Str MSG_FILAMENT_COLDPULL                  = _UxGT("Cold-Pull Filament");  
  PROGMEM Language_Str MSG_COLDPULL_ALL                       = _UxGT("Cold-Pull All");
  PROGMEM Language_Str MSG_FILCOLDPULL_E                      = _UxGT("Cold-Pull *");
  ...
  PROGMEM Language_Str MSG_FILAMENT_CHANGE_HEADER_COLDPULL    = _UxGT("COLD-PULL FILAMENT");
  ...
  //
    ...
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_COLDPULL        = _UxGT(MSG_2_LINE("Wait for", "filament cold-pull"));
    ...
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_CONT_PULL        = _UxGT(MSG_2_LINE("Click to finish", "cold pull"));
