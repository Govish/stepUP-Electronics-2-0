...
void menu_move() {
  ...
  if (
    ...
    GCODES_ITEM_SYNC(MSG_AUTO_HOME, G28_STR);
...
void menu_motion() {
  ...
  GCODES_ITEM_SYNC(MSG_AUTO_HOME, G28_STR);
    ...
    GCODES_ITEM_SYNC(MSG_AUTO_HOME_X, PSTR("G28X"));
    GCODES_ITEM_SYNC(MSG_AUTO_HOME_Y, PSTR("G28Y"));
    GCODES_ITEM_SYNC(MSG_AUTO_HOME_Z, PSTR("G28Z"));
  #endif
