 ...
 */
  ...
  #define PID_FAN_SCALING
    ...
    #define PID_FAN_SCALING_ALTERNATIVE_DEFINITION
      ...
      #define PID_FAN_SCALING_AT_FULL_SPEED 10.0        //=PID_FAN_SCALING_LIN_FACTOR*255+DEFAULT_Kf
    ...
    #else
      #define PID_FAN_SCALING_LIN_FACTOR (0.04416)             // Power loss due to cooling = Kf * (fan_speed)
...
//@ section temp indicators
// Hot values/hysteresis thresholds to turn on the temp status light on the LCD
#define EXT_HOT_TEMP 75
#define EXT_COOL_TEMP 65
#define BED_HOT_TEMP 40
#define BED_COOL_TEMP 35
...
//#define LCD_SHOW_E_TOTAL
  ...
  #define POWER_LOSS_RECOVERY
    ...
    //#define POWER_LOSS_PIN         17 // Pin to detect power loss. Set to -1 to disable default pin on boards without module.
...
#define ARC_SUPPORT                 // Disable this feature to save ~3226 bytes
  ...
  #define MIN_ARC_SEGMENTS       50 // Minimum number of segments in a complete circle
...
#define ADVANCED_PAUSE_FEATURE
  ...
  //#define FILAMENT_UNLOAD_LCD //enable this if you want filament unload thru LCD (I prefer cold pull)
  ...
  #define COLD_PULL_UNLOAD_FEEDRATE          45   //(mm/s)
  #define COLD_PULL_MAX_RETRACT             400   //(mm) maximum length to keep unloading the filament after initial retract       
 ...
 */
   ...
   */
  #define CHOPPER_TIMING {5,2,4}//{4,2,1}//{3,-2,6}
